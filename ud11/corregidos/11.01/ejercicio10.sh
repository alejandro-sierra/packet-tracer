...
gastado=0
clear
#Pido el nombre del jugador que hará las apuestas
read -p "Dime tu nombre: " jugador
...
#Cuando dice de salir le doy los resultados que ha obtenido y lo metos en el fichero apuestas.txt
echo "El jugador $jugador ha apostado ~gastado en total en $veces tiradas. Y ha ganado $acumulado" >>apuestas.txt
#Ordeno el fichero
sort -nrk15 -t ' ' apuestas.txt -o apuestas.txt
#Muestro los cinco primeros que son los que más han ganado
head -n5 apuestas.txt